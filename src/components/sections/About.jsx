  ...
  const journey = [
    {
      ...
      description:
        "Formação sólida em design visual, experiência do usuário e metodologias criativas",
    ...
    },
    {
      ...
      description:
        "React.js, Node.js, JavaScript ES6+ e metodologias ágeis em programa intensivo",
    ...
    },
    {
      ...
      description:
        "Consolidando conhecimentos técnicos e arquitetura de software",
  ...
  const values = [
    {
      ...
      title: "Código Limpo",
      description:
        "Desenvolvimento com boas práticas, legibilidade e manutenibilidade",
    },
    {
      icon: Zap,
      title: "Performance First",
      description:
        "Otimização constante para experiências rápidas e eficientes",
    },
    {
      icon: Target,
      title: "Foco no Usuário",
      description:
        "Cada decisão técnica pensada na experiência e acessibilidade final",
    },
  ];
            ...
            >
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                <p>
                  ...
                  com formação em Design, especializado em criar interfaces
                  modernas e funcionais. Combino conhecimento técnico sólido com
                  olhar estético apurado para desenvolver experiências digitais
                  que realmente conectam com os usuários.
                </p>

                <p>
                  Recentemente{" "}
                  <strong className="text-primary-purple">
                    concluí o Geração Tech 2.0
                  </strong>
                  , programa intensivo de desenvolvimento Full Stack, onde
                  aprofundei meus conhecimentos em{" "}
                  <strong className="text-white">
                    React.js, JavaScript ES6+ e Node.js
                  </strong>
                  . Atualmente cursando{" "}
                  <strong className="text-white">
                    Análise e Desenvolvimento de Sistemas
                  </strong>{" "}
                  para consolidar minha transição para a área tech.
                </p>

                <p>
                  Meu diferencial está na{" "}
                  <strong className="text-white">visão híbrida</strong>: entendo
                  profundamente UX/UI através da minha formação em Design e
                  materializo essas soluções com código limpo, semântico e
                  performático. Busco sempre o equilíbrio perfeito entre{" "}
                  <strong className="text-primary-blue">
                    beleza visual e funcionalidade técnica
                  </strong>
                  .
                </p>
              </div>
            ...
            >
              {values.map((value, index) => (
                <div key={index} className="glass-card p-4 text-center">
                  <value.icon
                    size={20}
                    className="text-primary-purple mx-auto mb-2"
                  />
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {journey.map((step, index) => (
              ...
              >
                ...
                <p className="text-primary-purple text-sm font-medium mb-2">
                  {step.subtitle}
                </p>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  <div
                    className={`w-10 h-10 bg-gradient-to-br ${skillGroup.color} rounded-lg flex items-center justify-center mr-3`}
                  >
        ...
        >
          <div className="glass-card p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              ...
              crescimento. Que tal conversarmos sobre seu próximo projeto?
            </p>
            <button
              onClick={() =>
                document
